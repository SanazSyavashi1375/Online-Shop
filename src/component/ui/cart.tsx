...
const Cart: React.FC<{
  ...
  return (
    <div className="box-border  border-solid border border-gray-100 shadow-xl flex flex-wrap px-2 my-5  h-1/3 w-11/12 mx-5/100 sm:w-45/100 mx-5/100  md:w-45/100 mx-5/100 lg:w-card mx-10/6  ">
      <div className="  w-full h-56 flex justify-center items-center content-center ">
        <div className=" w-36 h-56  overflow-hidden flex justify-center items-center content-center">
